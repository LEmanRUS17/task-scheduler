...
#[AsController]
final class DeleteTaskFilesController
{
    ...
    #[Route(
        '/task/{taskId}/files/{fileId}',
        name: 'task_files_delete',
        defaults: ['fileId' => null],
        methods: ['DELETE'],
    )]
    public function __invoke(string $taskId, ?string $fileId = null): Response
    {
        ...
        $this->fileService->deleteAttachments(Task::class, $taskId, $fileId);
